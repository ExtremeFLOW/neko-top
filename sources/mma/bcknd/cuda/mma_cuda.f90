submodule (mma) mma_cuda
use num_types, only: rp, c_rp
	implicit none
	public

	interface
	subroutine mma_gensub_device( x_d,  xold1_d, xold2_d, df0dx_d, dfdx_d, xlow_d, xupp_d, xmin_d, xmax_d, alpha_d, beta_d, p0j_d, q0j_d, pij_d, qij_d, bi_d,&
