program volume_sensitivity
  ...
  use json_utils, only: json_extract_object, json_extract_item
  ...
  type(json_file) :: parameters, design_parameters, volume_parameters
  ...
  call json_extract_item(parameters, 'optimization.constraints', 1, volume_parameters)
  ...
  call constraint_object%init_json_sim(volume_parameters, des, sim)
