...
!===========================================================================!
  ...
  ! intial value
  x = [5.0_rp, 5.0_rp, 5.0_rp, 5.0_rp, 5.0_rp]
  ! opt value
  ...
  print '(A,I3,A,5F10.4,A,F10.7,A,F10.7)', &
       'iter = ', 0, ' , x = ', x, '-------, f0val = ', f0val, ', fval = ', fval
...
contains
  ...
  subroutine func1 (n, m, x, f0val, df0dx, fval, dfdx)
    ...
    fval(1) = 61.0_rp / x(1)**3 + 37.0_rp / x(2)**3 + 19.0_rp / x(3)**3 + &
         7.0_rp / x(4)**3 + 1.0_rp / x(5)**3 - 1.0_rp

    dfdx(1,1) = -3.0_rp * 61.0_rp / x(1)**4
    dfdx(1,2) = -3.0_rp * 37.0_rp / x(2)**4
    dfdx(1,3) = -3.0_rp * 19.0_rp / x(3)**4
    dfdx(1,4) = -3.0_rp * 7.0_rp / x(4)**4
    dfdx(1,5) = -3.0_rp * 1.0_rp / x(5)**4
