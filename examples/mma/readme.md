...
The sensitivity (gradient) of the objective with respect to each design variable assuming $[d_1, d_2, \ldots, d_n]$ denote the vector of design variables reads:
...
Since the objective is minimum when the design field matchs the \(x\)-coordinates, the expected optimal solution is:
