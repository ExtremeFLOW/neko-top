...
wsrf_nsplit = DefineNumber[ 4 , Min 2, Max 20, Step 1, Name "Numer of splits; cylinder surface from the wake side" ];
// number of splits normal to the cylinder surface
nsrf_nsplit = DefineNumber[ 3 , Min 4, Max 20, Step 1, Name "Numer of splits; normal to the cylinder surface" ];
...
spnw_nsplit = DefineNumber[ 4 , Min 2, Max 50, Step 1,   Name "Spanwise numer of splits" ];
...
// Wall
Physical Curve("Wal",1) = {list(3),list(6),list(9),list(11)};

// Inflow
Physical Curve("Inf",2) = {list(14),list(24),list(26)};

// Outflow
Physical Curve("Out",3) = {list(17),list(28),list(30)};

// Top periodic
Physical Curve("Pet",4) = {list(23),list(27),list(31)};

// Bottom periodic
Physical Curve("Peb",5) = {list(20),list(25),list(29)};
