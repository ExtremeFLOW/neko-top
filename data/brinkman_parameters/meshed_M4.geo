...
nsrf_nsplit = DefineNumber[ 12 , Min 4, Max 20, Step 1, Name "Numer of splits; normal to the cylinder surface" ];
...
wnprog = DefineNumber[ 1.15 , Min 1, Max 2, Step 0.1,   Name "Progression normal to the cylinder surface" ];
